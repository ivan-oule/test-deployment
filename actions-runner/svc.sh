...
SVC_NAME="actions.runner.ivan-oule-test-deployment.test-deployment-runner"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (ivan-oule-test-deployment.test-deployment-runner)"
